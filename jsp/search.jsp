   ...
   <body>
    ...
    %>
     ...
     <main>
         ...
         <form class="d-flex" action="key.jsp" method="POST">
            <input type="text" placeholder="09XXXXXXXX"  name="phone" style="text-align:center">
       <button class="btn btn-outline-success" type="submit"> Search</button>
         ...
         request.setCharacterEncoding("UTF-8");
           ...
           if(session.getAttribute("phone") != null ){
              ...
              sql = "SELECT * FROM `member` WHERE `phone` LIKE'%" +session.getAttribute("phone") + "%'" ; 
              ...
              while(rs.next()){
                  ...
                  out.print("<h2><center>"+rs.getString("name")+"<br>");
             ...
             %>
                 ...
                 <div class="in-icon">
                        ...
                        <form action="friend_add.jsp">
                         <div class="in-icon-pic">
                             <img src="../img/add-friend.png" alt="">
           
                         
                            
                            <button class="btn btn-outline-success"  name="friends" type="submit" style="border: none;font-size: 25px;margin-left: -8px;"> 加入</button>
                         </div>
